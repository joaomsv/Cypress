...
describe('People Central', function () {
  ...
  it('Create User', function () {
    ...
    profile.getAreaResponsibilityAddBtn().click()
    profile.getAreaResponsibilityModalSearchField().click()
    profile.getAreaResponsibilityModalSearchField().type(this.userdata.area)
    profile.getAreaResponsibilityModalSearchResults().first().click()
    profile.getAddAreaResponsibilityModalAddBtn().click()
    profile.getAreaResponsibilityListDesc().each(($el, index, $list) => {
